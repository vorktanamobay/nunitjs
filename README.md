...
Path to javascript test directory relative to the project working directory. Defaults to src/test/js. This assumes that nunit.js is in src/test/js and fixtures are under src/test/js/fixtures.
